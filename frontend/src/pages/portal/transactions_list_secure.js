...
export const TransactionsListSecure = () => {
  const auth = useAuth();
  ...
  useEffect(() => {
    history.replace("/transactions/list-secure/" + filter);
  }, [filter]);
        ...
        <Col xs={12} sm={4}>
          <InputGroup size="sm" className="mb-3">
            ...
            <FormControl
              ...
              value={filter}
              onChange={(e) => setFilter(sanitizeHtml(e.target.value))}
            />
          </InputGroup>
        </Col>
